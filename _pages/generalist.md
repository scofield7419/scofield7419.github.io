---
title: "Hao Fei - Generalist"
layout: textlay
excerpt: "Hao Fei -- Generalist"
sitemap: false
permalink: /generalist/
---
...
<p align="center">
  <img src="{{ '/images/respic/research-state3.png' | relative_url }}" width="97%"/>
</p>
...
Below each research topic is shown, with representative publications [\[View complete publications\]]({{ '/publications' | relative_url }}):
...
Previously I paid my particular focus on [Structure-aware Intelligence Learning (SAIL)]({{ '/sail/' | relative_url }}), and worked on the following topics:
